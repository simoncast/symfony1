...
copy(__DIR__.'/fixtures/propel/schema.yml', $c->tmp_dir.DS.'config'.DS.'schema.yml');
copy(__DIR__.'/fixtures/propel/databases.yml', $c->tmp_dir.DS.'config'.DS.'databases.yml');
copy(__DIR__.'/fixtures/propel/propel.ini', $c->tmp_dir.DS.'config'.DS.'propel.ini');
...
copy(__DIR__.'/fixtures/propel/Category.php', $c->tmp_dir.DS.'lib'.DS.'model'.DS.'Category.php');
...
copy(__DIR__.'/fixtures/task/aTask.class.php', $c->tmp_dir.DS.'lib'.DS.'task'.DS.'aTask.class.php');
copy(__DIR__.'/fixtures/task/zTask.class.php', $c->tmp_dir.DS.'lib'.DS.'task'.DS.'zTask.class.php');
